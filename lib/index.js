...
module.exports = {
	...
	activate: function(state) {
		...
		atom.commands.add('atom-workspace', {
			...
			'triple-folds:collapse-this': this.toggleCollapse.bind(this, null, true),
			'triple-folds:uncollapse-this': this.toggleCollapse.bind(this, null, false),
		});
	...
	foldStart: /{{{/, // Compiled RegExp of the folding lines
	foldEnd: /}}}/, // Compiled RegExp of the unfolding lines
